...
if ($dbg -ne "")  {
	write-output "Command: $pasoeJmxCall  -cp ""$oejmx"";""$jacksonmapper"";""$jacksoncore""  $pasoeJmxCallClass $pasoepid $query $qResults"
}
# Run jxm request
& $pasoeJmxCall  -cp """$oejmx"";""$jacksonmapper"";""$jacksoncore""" $pasoeJmxCallClass $pasoepid $query $qResults
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUXEmavtmnSElv4vtNzCVITUp0
# UF+gghLqMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSpB2iHYPHzRCbOFGvFJ1eoyLiCGTAN
# BgkqhkiG9w0BAQEFAASCAQAI9sJCBT4HwZFCKjp7nCIR8ThBptx5fjdoJGuvJq9N
# Vhvi/4csxp6EkKd2/qS4ldu1AqNs2aPfcHTkP7oEGonzHo7GKeOhk3BpHkXDYQiB
# cB3aJTgCOqAG9Y0+Ntk6LlP29U67OU32TTCWlvEGPNWOh22g77Lh2xpI3rBsOahc
# dlEuM16b++nB45rnSCxPSawjuBCMHBcbvaDUFdzBgBh89z8H7LbFCOUaPiILV7Fg
# YiTBKjDMeBh0p/sEN9TxnsgBR7t9+vEeCzESXb7VHabyG7V7rhnyeBCuKNaADn0E
# VUgdfjiFdXOSNq/MkHBfVS8w+Zt12q/8g0nrYU/3yc8aoYICCzCCAgcGCSqGSIb3
...
# MTE5MTc0M1owIwYJKoZIhvcNAQkEMRYEFEKPVzm9w0b5qKzE0/5lJR3SLHwYMA0G
# CSqGSIb3DQEBAQUABIIBAJ1y56DiWWBgQr2HCEebw+ZePXSDua0bdFojPV8inIrO
# RTFXE+Xb2xeb9xmVG0MJDhpmdenHxUmuOi0uRkGhrl6J4ujR5DP8Y4H4Mrh39FTn
# jNNntyf53itnAyoMq1H8cf6SMqxrbxMTL3mtA8epRfo4nZKxPMu5U3EGmJi3SSXU
# AbfzXLP6J/uVNpr12qWle6/pAxvo3v+6Fs5XqE0r6hToYD6HLyWQyy+2ZdGV4UqR
# 7Nwsh6kyXNgI1OHAVLFYypSdu6bxloPV3aIaLO0MV4grc7Roi6XfwxYVA1l7Y7vx
# oDdl/PnazgAHczFGntpBYneruMzrHGFgzrYAZbYjXsA=
